# 2019 Spring "BME Basic Statistics" for graduate students
...
You can download the class materials using the following command line.
	...
	$ git clone https://github.com/wanirepo/Grad_Stats_2019Spring
...
This course will combine lectures with some practical hands-on experience of statistical data analysis and paper presentations. We will use English as the main language, but you can use Korean to ask questions and discuss. 
...
Analyzing data from your lab using the statitical methods you learned in the class
